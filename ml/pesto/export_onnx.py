...
-----
  ...
  poetry run python ml/pesto/export_onnx.py --sample-rate 44100 --opset 17
  poetry run python ml/pesto/export_onnx.py --verify-audio data/v0/guitar/E2_260427_1446.wav
"""
import argparse
import json
import logging
