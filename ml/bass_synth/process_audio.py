...
Usage:
  # Single file
  python -m ml.bass_synth.process_audio --run runs/v0/20260505_120000 --input path/to/guitar.wav

  # Folder
  python -m ml.bass_synth.process_audio --run runs/v0/20260505_120000 --input data/v0/guitar/
"""
